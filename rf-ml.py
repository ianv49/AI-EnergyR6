...
def generate_html(ml_daily, nasa_daily, metrics_text, total_api_rows):
    """Generate hardcoded rf-ml.html with data from rf-ml.txt"""
    html_file = Path("rf-ml.html")
...
<head>
  ...
  <title>RF-ML | Energy Data Summary</title>
    ...
    <div class="main-summary">
      <div class="summary-cards">
        <div class="summary-card" style="grid-column: 1 / -1;">
          <div class="summary-label">RF Performance & Config</div><table style="width: 100%; border-collapse: collapse; font-size: 0.88em;">
            <thead>
...
<tr style="border-top: 2px solid rgba(255,255,255,0.1); padding: 8px 0;">
  ...
  <td style="text-align: left; font-weight: 600; color: #06b6d4; padding-left: 10px;" colspan="4">RandomForest</td>
 </tr>
...
def main():
    ...
    with open(ml_output_file, "w") as f:
        ...
        f.write(f"# Summary: Training data = {total_api_rows} | full-api actual = {len(nasa_daily)} | RF predict = {len(ml_daily)}\n")
        f.write("[full-api]\n\n")
    ...
    print(f"✅ rf-ml.html generated with hardcoded data from rf-ml.txt")
